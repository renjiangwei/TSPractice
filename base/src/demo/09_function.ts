...
*/
function c (name: string, age?:number): void {
...
*/
{
  let max:(num: number, ...rest:number[])=>number = 
  function (num, ...rest:number[]) {
...
*/
{
  function a(arg:number): Array<object>;
  function a(arg:Array<object>): number;
